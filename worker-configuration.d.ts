/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 96b05752d3628ac92fae0cd4d7bde626)
// Runtime types generated with workerd@1.20260515.1 2026-05-19 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	VIDEOS_BUCKET: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	BETTER_AUTH_SECRET: "pue-link-local-demo-secret-change-before-production";
	BETTER_AUTH_URL: "http://localhost:4321";
	PUBLIC_ONESIGNAL_APP_ID: "fb3dde7a-e046-48e1-bcde-e7dfd4a8185c";
	PUE_LINK_ALLOW_SEED: "true";
	PUE_LINK_DEFAULT_THRESHOLD: "5";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "PUBLIC_ONESIGNAL_APP_ID" | "PUE_LINK_ALLOW_SEED" | "PUE_LINK_DEFAULT_THRESHOLD">> {}
}
