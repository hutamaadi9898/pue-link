...
const demoUsers = [
  ...
  { label: "Keluarga", email: "family@puelink.test" },
  { label: "Gelang", email: "device-oma@puelink.test" },
  { label: "Minimarket", email: "minimarket@puelink.test" },
  { label: "Taman", email: "taman@puelink.test" }
];
      ...
      <section className="grid w-full max-w-5xl overflow-hidden rounded-lg border bg-card shadow-sm lg:grid-cols-[0.92fr_1.08fr]">
        <div className="p-6 sm:p-8 lg:p-10">
          ...
          <div className="max-w-sm">
            <Badge variant="secondary">Login demo</Badge>
            <h1 className="mt-4 text-2xl font-bold tracking-normal">Selamat datang kembali</h1>
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              Masuk dengan email dan password untuk membuka layar sesuai peran akun.
            </p>
          </div>
          ...
          <div className="mt-8 max-w-sm">
            <p className="mb-3 text-xs font-semibold uppercase text-muted-foreground">Login sebagai</p>
              ...
              <div>
                ...
                <div className="mt-10 grid aspect-video place-items-center overflow-hidden rounded-lg border border-white/15 bg-slate-900">
                  <div className="grid gap-4 text-center">
                    ...
                    <p className="text-sm text-white/70">Video keluarga siap diputar</p>
                  </div>
                </div>
              </div>
              <blockquote className="max-w-sm text-2xl font-bold leading-tight">
                Kenangan hari ini kembali dengan satu scan sederhana.
              </blockquote>
            </CardContent>
          </Card>
        </div>
